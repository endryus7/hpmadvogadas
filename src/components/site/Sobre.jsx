    ...
    <section id="sobre" className={styles.section}>
      <div className={`container-x ${styles.container}`}>
        <SectionTitle
          ...
          description={
            <>
              O Hermann, Piccoli & Montezano é fundado por três advogadas associadas, com atuação centrada no cliente. Mais do que prestar serviços jurídicos, buscamos construir vínculos de confiança oferecendo escuta cuidadosa, análise técnica e acompanhamento próximo em cada etapa do caso.
            </>
          }
        />
